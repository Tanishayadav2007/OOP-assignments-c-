/* Assignment 4 (including 2 and 3 assignment )
Part A: Custom Exceptions 
1. Create a hierarchy of custom exception classes: 
o UniversitySystemException (base exception class) 
o EnrollmentException (for enrollment-related errors) 
o GradeException (for grading-related errors) 
o PaymentException (for payment-related errors) 
o Any other exception types you deem necessary 
2. Make each exception store relevant information about the error. 
3. Implement appropriate constructors and methods to retrieve error details. 
Part B: Exception Handling 
1. Modify your existing code to throw appropriate exceptions: 
o EnrollmentManager should throw exceptions for: 
▪ Enrolling in a full course 
▪ Enrolling in a course with unmet prerequisites 
▪ Enrollment deadline violations 
o GradeBook should throw exceptions for: 
▪ Invalid grade entries 
▪ Unauthorized grade changes 
▪ Attempting to finalize grades for students who haven't completed 
requirements 
o Person-derived classes should throw exceptions for: 
▪ Invalid ID assignments 
▪ Invalid contact information 
▪ Payment calculation errors 
2. Implement proper try-catch blocks in your test program. 
3. Add a logging mechanism to record exceptions when they occur. 
Part C: System Integration 
1. Create a UniversitySystem class that integrates all components: 
o Manages departments, courses, students, and professors 
o Handles enrollment 
o Processes grades 
o Calculates payments 
o Generates reports 
2. Implement a menu-driven test program that demonstrates all features of the 
system. 
3. Ensure all operations include proper exception handling with informative error 
messages. 
4. Add the ability to: 
o Create a new semester 
o Enroll students in courses 
o Assign professors to courses 
o Enter and calculate grades 
